...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    class SerializedFrameSettings
    {
        ...
        {
            get => GetData(FrameSettingsField.ShaderLitMode) ? LitShaderMode.Deferred : LitShaderMode.Forward;
            set => SetData(FrameSettingsField.ShaderLitMode, value == LitShaderMode.Deferred);
        }

        public bool GetData(FrameSettingsField field) => rootData.GetBitArrayAt((uint)field);
        public void SetData(FrameSettingsField field, bool value) => rootData.SetBitArrayAt((uint)field, value);
