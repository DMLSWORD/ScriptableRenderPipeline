...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    partial class FrameSettingsUI
    {
        ...
        // Headers
        static readonly GUIContent renderingPassesHeaderContent = EditorGUIUtility.TrTextContent("Rendering Passes");
        static readonly GUIContent renderingSettingsHeaderContent = EditorGUIUtility.TrTextContent("Rendering Settings");
        static readonly GUIContent lightSettingsHeaderContent = EditorGUIUtility.TrTextContent("Lighting Settings");
        static readonly GUIContent asyncComputeSettingsHeaderContent = EditorGUIUtility.TrTextContent("Async Compute Settings");
